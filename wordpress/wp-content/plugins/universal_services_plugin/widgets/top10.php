...
class themerex_widget_top10 extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_top10', 'description' => esc_html__('Top 10 posts by average reviews marks (by author and users)', 'trx_addons'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'themerex_widget_top10');

		/* Create the widget. */
		parent::__construct( 'themerex_widget_top10', esc_html__('ThemeREX - Top 10 Posts', 'trx_addons'), $widget_ops, $control_ops );

		// Add thumb sizes into list
		themerex_add_thumb_sizes( array( 'layout' => 'widgets', 'w' => 90, 'h' => 70, 'h_crop' => 70, 'title'=>esc_html__('Widgets', 'trx_addons') ) );
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_author')); ?>"><?php esc_html_e('Author rating tab title:', 'trx_addons'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_users')); ?>"><?php esc_html_e('Users rating tab title:', 'trx_addons'); ?></label>
		...
		<p>
			...
			<select id="<?php echo esc_attr($this->get_field_id('category')); ?>" name="<?php echo esc_attr($this->get_field_name('category')); ?>" style="width:100%;">
				<option value="0"><?php esc_html_e('-- Any category --', 'trx_addons'); ?></option>
			<?php
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_image')); ?>_2"><?php esc_html_e('Show as icon', 'trx_addons'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_2"><?php esc_html_e('As stars', 'trx_addons'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_1"><?php esc_html_e('As icon', 'trx_addons'); ?></label>
