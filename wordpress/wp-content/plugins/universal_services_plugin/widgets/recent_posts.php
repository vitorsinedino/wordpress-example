...
class themerex_widget_recent_posts extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_posts', 'description' => esc_html__('The recent blog posts (extended)', 'trx_addons'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'themerex_widget_recent_posts');

		/* Create the widget. */
		parent::__construct( 'themerex_widget_recent_posts', esc_html__('ThemeREX - Recent Posts', 'trx_addons'), $widget_ops, $control_ops );
