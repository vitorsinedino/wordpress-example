...
class themerex_widget_flickr extends WP_Widget {
	...
	function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'themerex_widget_flickr', esc_html__('ThemeREX - Flickr photos', 'trx_addons'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'count' => 6, 'description' => esc_html__('Last flickr photos', 'trx_addons') );
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'flickr_username' )); ?>"><?php esc_html_e('Flickr ID (http://www.idgettr.com):', 'trx_addons'); ?></label>
