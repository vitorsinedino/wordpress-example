...
class themerex_widget_popular_posts extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_popular_posts', 'description' => esc_html__('The most popular and most commented blog posts (extended)', 'trx_addons'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'themerex_widget_popular_posts');

		/* Create the widget. */
		parent::__construct( 'themerex_widget_popular_posts', esc_html__('ThemeREX - Most Popular & Commented Posts', 'trx_addons'), $widget_ops, $control_ops );
	}
